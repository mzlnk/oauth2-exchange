...
class OktaAuthorizationCodeExchangeClientTest {
    ...
    void "Should return exception if clientId parameter is null for single-sign-on client"() {
        ...
        def exception = assertThrows(
                ...
                () -> new OktaAuthorizationCodeExchangeClient.OktaSingleSignOnClient(clientId, clientSecret, redirectUri, oktaDomain)
        )
    ...
    void "Should return exception if clientId parameter is null for authorization server client"() {
        ...
        def exception = assertThrows(
                NullPointerException,
                () -> new OktaAuthorizationCodeExchangeClient.OktaAuthorizationServerClient(
                        clientId,
                        clientSecret,
                        redirectUri,
                        oktaDomain,
