 ...
 */
public final class MicrosoftOAuth2OrganizationsClient extends MicrosoftOAuth2Client {
     ...
     */
    public MicrosoftOAuth2OrganizationsClient(@NotNull String clientId,
     ...
     * the Microsoft OAuth2 authorization code flow related client, the token URL is <i>https://login.microsoftonline.com/organizations/oauth2/v2.0/token</i>.
     *
