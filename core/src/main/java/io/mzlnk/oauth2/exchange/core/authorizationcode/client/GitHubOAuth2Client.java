...
/**
 * Represents an implementation of {@link OAuth2Client} for GitHub OAuth2 authorization code flow.
 ...
 */
public final class GitHubOAuth2Client extends AbstractOAuth2Client {
     ...
     */
    public GitHubOAuth2Client(@NotNull String clientId,
     ...
     * OAuth2 authorization code flow, the token URL is <i>https://github.com/login/oauth/access_token</i>.
     *
