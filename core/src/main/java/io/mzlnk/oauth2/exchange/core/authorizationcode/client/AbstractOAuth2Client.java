 ...
 * authorization code exchanges. It implements all of the {@link OAuth2Client} methods
 * except the {@link OAuth2Client#getTokenUrl()} which has to be implemented in
...
public abstract class AbstractOAuth2Client implements OAuth2Client {
     ...
     */
    protected AbstractOAuth2Client(@NotNull String clientId,
