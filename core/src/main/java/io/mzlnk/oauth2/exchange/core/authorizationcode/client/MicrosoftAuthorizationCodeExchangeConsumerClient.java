 ...
 */
public final class MicrosoftAuthorizationCodeExchangeConsumerClient extends MicrosoftAuthorizationCodeExchangeClient {
     ...
     */
    public MicrosoftAuthorizationCodeExchangeConsumerClient(@NotNull String clientId,
