 ...
 */
public final class MicrosoftOAuth2TokenResponse extends AbstractOAuth2TokenResponse {

    private MicrosoftOAuth2TokenResponse(@NotNull Map<String, Object> values) {
        super(values);
    }
    ...
    /**
     * Represents factory to create OAuth2 token response received from Microsoft authorization provider.
     */
    public static final class Factory implements OAuth2TokenResponse.Factory {
        ...
        public OAuth2TokenResponse create(@NotNull Map<String, Object> values) {
            return new MicrosoftOAuth2TokenResponse(values);
        }
