 ...
 */
public abstract class AbstractOAuth2TokenResponse implements OAuth2TokenResponse {
     ...
     */
    protected AbstractOAuth2TokenResponse(@NotNull Map<String, Object> values) {
        this();
     ...
     */
    protected AbstractOAuth2TokenResponse() {
